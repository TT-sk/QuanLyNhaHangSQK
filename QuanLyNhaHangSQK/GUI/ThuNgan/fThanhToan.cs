...
namespace QuanLyNhaHangSQK.GUI
{
    public partial class fThanhToan : Form
    {
        ...
        private void lbThemThongTinKhachHang_Click(object sender, EventArgs e)
        {

            fThemThongTinKhachHang f = new fThemThongTinKhachHang(Ban, NguoiDung, int.Parse(lbMaHoaDon.Text));
            f.ShowDialog();
        }
