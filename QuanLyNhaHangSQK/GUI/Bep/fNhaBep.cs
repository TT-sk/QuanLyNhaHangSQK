        ...
        public void TaiDanhSachChuaNau(int HienTrang)
        {
            ...
            foreach (var item in danhSachMenuBep)
            {
                ...
                Label labelChuyen = new Label()
                {
                    ...
                    TextAlign = ContentAlignment.MiddleLeft,
                    Image = Image.FromFile(@"C:\Users\thien\Downloads\res\quanlynhahang\QuanLyNhaHangFul\QuanLyNhaHangSQK\QuanLyNhaHangSQK\Resources\Chuyen2.png"),
        ...
        public void TaiDanhSachDaNau(int HienTrang)
        {
            ...
            foreach (var item in danhSachMenuBep)
            {
                ...
                Label labelThongBao = new Label()
                {
                    ...
                    Location = new Point(619, 16),
                    TextAlign = ContentAlignment.MiddleLeft,
                    Image = Image.FromFile(@"C:\Users\thien\Downloads\res\quanlynhahang\QuanLyNhaHangFul\QuanLyNhaHangSQK\QuanLyNhaHangSQK\Resources\ThongBao.png"),
                    BackColor = Color.Transparent
                };
